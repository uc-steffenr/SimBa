...
class Environment:
    ...
    def _generate_environment(self):
        ...
        while True:
            ...
            agent_within_check = any([X0.within(obst) \
            ...
            if not agent_within_check and not xt_within_check and \
               not agent_within_distance_check and \
               not xt_within_distance_check:
                break
